...
// Arducorder Mini Pins
#define ADAFRUIT_CC3000_IRQ   2  // MUST be an interrupt pin! (3)
#define ADAFRUIT_CC3000_VBAT  70 // (5)
#define ADAFRUIT_CC3000_CS    53 // (10)

/*
#define ADAFRUIT_CC3000_IRQ   3  // MUST be an interrupt pin! (3)
#define ADAFRUIT_CC3000_VBAT  5 // (5)
#define ADAFRUIT_CC3000_CS    10 // (10)
*/

//Adafruit_CC3000 cc3000 = Adafruit_CC3000(ADAFRUIT_CC3000_CS, ADAFRUIT_CC3000_IRQ, ADAFRUIT_CC3000_VBAT);
Adafruit_CC3000 cc3000 = Adafruit_CC3000(ADAFRUIT_CC3000_CS, ADAFRUIT_CC3000_IRQ, ADAFRUIT_CC3000_VBAT,
                                         SPI_CLOCK_DIV16, &Serial); // you can change this clock speed
/**************************************************************************/
/*!
...
void displayFirmwareVersion(void)
{
  ...
  else
  {
    ...
    Serial.print(major, DEC); Serial.print(F(".")); Serial.println(minor, DEC);
  }
  #endif
}
