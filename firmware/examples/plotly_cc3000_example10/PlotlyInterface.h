// PlotlyInterface.h
// ================================================================================================
// Note: You will need to replace the username/api key data on lines 30-36 with your account 
// information after signing up to plotly.  You will also have to enter in your router SSID.
// ================================================================================================
...
// Plotly Variables
#define PLOTLY_USERNAME  "myusername"
#define PLOTLY_APIKEY    "myapikey"
...
class PlotlyInterface {
  ...
  void plotStaticGraph(char* filename, char* yAxisLabel, uint16_t size, uint16_t* data, char* xAxisLabel, float xStart, float xStep, boolean isBarGraph);
  void transmitBuffer();
