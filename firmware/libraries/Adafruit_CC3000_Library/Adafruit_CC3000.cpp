...
void Adafruit_CC3000::printIPdots(uint32_t ip) {
  if (CC3KPrinter == 0) return;
  CC3KPrinter->print((uint8_t)(ip), DEC);
  CC3KPrinter->print('.');
  CC3KPrinter->print((uint8_t)(ip >> 8), DEC);
  CC3KPrinter->print('.');
  CC3KPrinter->print((uint8_t)(ip >> 16), DEC);
  CC3KPrinter->print('.');
  CC3KPrinter->print((uint8_t)(ip >> 24), DEC);  
}
